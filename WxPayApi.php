...
//		dd($inputObj);
	...
	{
		//获取通知的数据
//		$xml = $GLOBALS['HTTP_RAW_POST_DATA'];//This feature has been DEPRECATED as of PHP 5.6.0. Relying on this feature is highly discouraged.  http://php.net/manual/zh/reserved.variables.httprawpostdata.php
